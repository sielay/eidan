...
Thank you for your interest in contributing to **eidan**, a project
maintained by **Sielay Ltd** ("the Company"). To make contributions
clean for everyone, we ask that you agree to the following terms.
...
intentionally submit to the Company for inclusion in the eidan
project. "Submitted" means any form of electronic, verbal, or
written communication sent to the Company or its representatives,
including communication on the eidan repositories, mailing lists,
source code control systems, or issue tracking systems.
Communication explicitly marked or designated in writing by you as
"not a Contribution" is excluded.

## 2. Grant of Copyright License

Subject to the terms of this Agreement, you grant the Company and
...
recipients of software distributed by the Company a perpetual,
worldwide, non-exclusive, no-charge, royalty-free, irrevocable
(except as stated below) patent license to make, have made, use,
...
combination of your Contribution(s) with the work to which the
...
creation, or that you have sufficient rights to submit it under the
terms of this Agreement. You represent that your Contribution
...
and trademarks) of which you are personally aware and which are
...
## 7. Outbound License — eidan Core Remains AGPL
...
**By signing below — or by clicking through the CLA-assistant
prompt on your first pull request — you accept these terms.**

You retain copyright on your Contribution. This Agreement does not
transfer copyright; it grants the Company the licenses described
above.
