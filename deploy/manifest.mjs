...
export const CORE_PLUGINS = [
  "storage-postgres", "vault-postgres", "llm-calls", "telemetry", "tool-guard", "tool-failure-handler", "transcribe", "memory", "tool-store", "decisions", "journal", "content", "crm", "auth", "notify", "jobs",
