...
// plugins' `ctx.secret` accessor. Optional lookups swallow MissingSecretError. Same shape every
// eidan plugin uses (copied from the mail/db bundles) so secrets are read identically everywhere.
